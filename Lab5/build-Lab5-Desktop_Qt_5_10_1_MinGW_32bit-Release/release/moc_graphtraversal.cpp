...
QT_MOC_LITERAL(8, 80, 10), // "curentPath"
QT_MOC_LITERAL(9, 91, 8), // "finished"
QT_MOC_LITERAL(10, 100, 12), // "deepthSearch"
QT_MOC_LITERAL(11, 113, 11) // "widthSearch"

    },
    "GraphTraversal\0repaintVertex\0\0Vertex*\0"
    "repaintEdge\0Edge*\0curentVertex\0"
    "curentEdge\0curentPath\0finished\0"
    "deepthSearch\0widthSearch"
};
...
void GraphTraversal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->curentPath((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        case 5: _t->finished(); break;
        case 6: _t->deepthSearch(); break;
        case 7: _t->widthSearch(); break;
        default: ;
        }
        ...
        {
            typedef void (GraphTraversal::*_t)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphTraversal::curentPath)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void GraphTraversal::curentPath(QStringList _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
