...
QT_MOC_LITERAL(8, 80, 3), // "log"
QT_MOC_LITERAL(9, 84, 8), // "finished"
QT_MOC_LITERAL(10, 93, 12), // "deepthSearch"
QT_MOC_LITERAL(11, 106, 11) // "widthSearch"

    },
    "GraphTraversal\0repaintVertex\0\0Vertex*\0"
    "repaintEdge\0Edge*\0curentVertex\0"
    "curentEdge\0log\0finished\0deepthSearch\0"
    "widthSearch"
};
...
void GraphTraversal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GraphTraversal::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GraphTraversal::log)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void GraphTraversal::log(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
